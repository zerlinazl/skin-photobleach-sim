...
from photobleach_pattern import PhotobleachPattern, PhotobleachPattern3Z, PhotobleachPattern4, PhotobleachPatternVarZC, PhotobleachPattern4Z, PhotobleachPattern5, PhotobleachPattern5a, PhotobleachPattern5Z, PhotobleachPattern5Z2
...
class RankLines3Z2():
    def setup(self):
        ...
        self.photobleach_pattern = PhotobleachPattern3Z(
            A_x_um=0,
            A_z_um=0,
            beta1=1,
            beta0_um=0,
...
class RankLines4splitZ1():
    def setup(self):
        self.photobleach_pattern = PhotobleachPattern4splitZ1(
            A_x_um=0,
            A_z_um=0,
            beta1=1,
            beta0_um=0,
...
class RankLines5split1Z():
    def setup(self):
        self.photobleach_pattern = PhotobleachPattern5splitZ(
            A_x_um=0,
            A_z_um=0,
            beta1=1,
            beta0_um=0,
...
def main():
    ...
    rank_lines3z2 = RankLines3Z2()
    rank_lines3z2.setup()
    rank3z2 = get_rank(rank_lines3z2.M)
    rank_binned3z2 = get_rank(rank_lines3z2.M_binned)

    print("3 LINES Z2:")
    print(rank_lines3z2.M_binned.T)
    print("--------------------------------")
    print("Rank: ",rank3z2)
    print("Rank binned: ", rank_binned3z2)

    rank_lines4splitZ1 = RankLines4splitZ1()
    rank_lines4splitZ1.setup()
    rank4splitZ1 = get_rank(rank_lines4splitZ1.M)
    rank_binned4splitZ1 = get_rank(rank_lines4splitZ1.M_binned)

    print("4 LINES SPLIT Z1:")
    print(rank_lines4splitZ1.M_binned.T)
    print("--------------------------------")
    print("Rank: ",rank4splitZ1)
    print("Rank binned: ", rank_binned4splitZ1)

    rank_lines5split1Z = RankLines5split1Z()
    rank_lines5split1Z.setup()
    rank5split1Z = get_rank(rank_lines5split1Z.M)
    rank_binned5split1Z = get_rank(rank_lines5split1Z.M_binned)

    print("5 LINES SPLIT 1 Z:")
    print(rank_lines5split1Z.M_binned.T)
    print("--------------------------------")
    print("Rank: ",rank5split1Z)
    print("Rank binned: ", rank_binned5split1Z)
